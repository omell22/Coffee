...
//     // Измените значение 200 на то, при скольких пикселях от верха страницы вы хотите изменить цвет
//     arrowUp.style.backgroundColor = "red"; // Измените цвет на желаемый
//   } else {
//     arrowUp.style.backgroundColor = "blue"; // Вернуть начальный цвет
//   }
// });
